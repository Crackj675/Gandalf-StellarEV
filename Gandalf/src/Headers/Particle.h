...
struct Particle
{
  ...
  FLOAT outflowFlag;					        ///< Only for Analyse --- can be deleted
  ...
  FLOAT temp_ambient;               ///< Ambient temperature of the particle
...
struct SphParticle : public Particle<ndim>
{
  ...
  FLOAT tdav;                       ///< Time dependent alpha viscosity value
...
struct GradhSphParticle : public SphParticle<ndim>
{
  ...
  public:
	  ...
	  m(0), rho (0), h(0), hrangesqd(0), hfactor(0), pfactor(0), sound(0), u(0), alpha(0), zeta(0), gamma(0)
	  {};
