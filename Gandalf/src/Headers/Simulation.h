...
class SimulationBase
{
 ...
 public:
  ...
  int outflowTiming;                   ///< Trigger to start outflows at nresync
...
class Simulation : public SimulationBase
{
 ...
 public:
  ...
  AccretionFB<ndim> *accfb;            ///< Accretion feedback pointer
  Outflow<ndim> *outf;                 ///< Outflow module pointer
  StellarEvolution<ndim> *stellarEv;   ///< Stellar evolution model pointer
#ifdef MPI_PARALLEL
...
class SphSimulation : public Simulation<ndim>
{
 public:
  ...
  using Simulation<ndim>::outflowTiming;
  ...
  using Simulation<ndim>::outf;
  using Simulation<ndim>::accfb;
  using Simulation<ndim>::stellarEv;
#ifdef MPI_PARALLEL
...
class MfvMusclSimulation : public MeshlessFVSimulation<ndim>
{
 public:
  ...
  using Simulation<ndim>::radiation;
  using Simulation<ndim>::snDriver;
  using MeshlessFVSimulation<ndim>::uint;
