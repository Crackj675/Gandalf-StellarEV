...
protected:
  ...
  void SphericalShell(const int, const FLOAT *, const FLOAT, const FLOAT, FLOAT *); 
...
//=================================================================================================
template <int ndim>
class BonnorEbertSphereIc : public Ic<ndim>
{
protected:
...
public:
  ...
  BonnorEbertSphereIc(Simulation<ndim>* _sim, FLOAT _invndim);
  virtual ~BonnorEbertSphereIc() {};
