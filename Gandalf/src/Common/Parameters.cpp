...
void Parameters::SetDefaultValues(void)
{
  ...
  floatparams["alpha_vir"]=0.85;
  floatparams["rho_ambient"]=0.0;
  floatparams["R_ambient"]=0.0;
  floatparams["T_ambient"]=0.0;
  floatparams["omega"] = 0.0;
  intparams["kminMode"] = 1;
  ...
  // Accretion feedback parameters
  //-----------------------------------------------------------------------------------------------
  stringparams["acc_fb"]            = "none";
  floatparams["AccFBminMass"]       = 0.025;
  floatparams["f_acc"]              = 0.75;
  floatparams["alpha_MRI"]          = 0.1;
  floatparams["dmdt_BGR"]           = 1.0e-7;
  floatparams["dmdt_max"]           = 10.0;

  // Outflow parameters
  //-----------------------------------------------------------------------------------------------
  intparams["outflow_fb"]           = 0;
  intparams["Nout"]                 = 1;
  floatparams["R_launch"]           = 15.0;
  floatparams["f_vel"]              = 1.;
  floatparams["op_angle"]           = 0.4;
  floatparams["f_angmom"]           = 0.9;
  floatparams["f_eject"]            = 0.1;
  floatparams["theta0"]  		        = 0.005;
	floatparams["r_eject"]						= 20.0;

  // Stellar evolution parameters
  //-----------------------------------------------------------------------------------------------	
	stringparams["stellarEv"]					= "none";
